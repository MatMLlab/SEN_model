...
def MatCheCon(ele_inp, mat_inp, index_inp, real_bp, n_loop = 3, alpha = 0.5):
    ...
    def chemical_env(n_loop, atom_vec_, bond_vec_, state_vec_):
        ...
        return atom_vec_, bond_vec_, state_vec_, x_comp
    ...
    atom_vec_, bond_vec_, state_vec_, x_comp = chemical_env(n_loop, atom_vec_, bond_vec_, state_vec_)
